...
# comments below their corresponding command lines. The 
# solutions to the two tasks that were given during the session 
...
summary(mlr_mlu)
# Call:
# lm(formula = mot ~ chi + age, data = mlu)
# 
# Residuals:
#      Min       1Q   Median       3Q      Max 
# -0.59107 -0.15183  0.01403  0.18385  0.51756 
# 
# Coefficients:
#             Estimate Std. Error t value Pr(>|t|)    
# (Intercept)  4.87176    0.58677   8.303 4.52e-08 ***
# chi         -0.40176    0.36455  -1.102    0.283    
# age          0.06332    0.04076   1.553    0.135    
# ---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
# 
# Residual standard error: 0.3084 on 21 degrees of freedom
# Multiple R-squared:  0.2172,	Adjusted R-squared:  0.1426 
# F-statistic: 2.913 on 2 and 21 DF,  p-value: 0.07645
...
# Residuals:
#      Min       1Q   Median       3Q      Max 
# -0.53860 -0.17397  0.00161  0.20283  0.54614 
# 
# Coefficients:
#             Estimate Std. Error t value Pr(>|t|)  
# (Intercept)  3.88305    1.47120   2.639   0.0157 *
# chi         -0.02688    0.62963  -0.043   0.9664  
# age          0.09304    0.05776   1.611   0.1229  
# chi:age     -0.01068    0.01455  -0.734   0.4712  
# ---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
# 
# Residual standard error: 0.3118 on 20 degrees of freedom
# Multiple R-squared:  0.2377,	Adjusted R-squared:  0.1234 
# F-statistic: 2.079 on 3 and 20 DF,  p-value: 0.1351
